	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(1, 1)
						.addBox(-8.0F, -6.0F, -4.0F, 16.0F, 14.0F, 26.0F, new CubeDeformation(0.02F)).texOffs(90, 33)
		...
		PartDefinition head = body.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(61, 1)
						.addBox(-7.0F, -5.0F, -19.0F, 14.0F, 6.0F, 19.0F, new CubeDeformation(0.0F)).texOffs(1, 13)
						.addBox(-8.0F, -11.0F, -14.0F, 2.0F, 11.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(1, 13)
						.addBox(6.0F, -11.0F, -14.0F, 2.0F, 11.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -3.0F, -2.0F, 0.8727F, 0.0F, 0.0F));

		PartDefinition right_ear = head.addOrReplaceChild("right_ear",
				CubeListBuilder.create().texOffs(1, 1).addBox(-6.0F, 0.0F, -3.0F, 6.0F, 1.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-7.0F, -5.0F, -2.0F, 0.0F, 0.0F, -0.8727F));

		PartDefinition left_ear = head.addOrReplaceChild("left_ear",
				CubeListBuilder.create().texOffs(1, 6).addBox(0.0F, 0.0F, -3.0F, 6.0F, 1.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(7.0F, -5.0F, -2.0F, 0.0F, 0.0F, 0.8727F));

		PartDefinition leg_back_right = partdefinition.addOrReplaceChild("leg_back_right", CubeListBuilder.create()
				.texOffs(21, 45).addBox(-14.0F, -3.0F, -4.0F, 5.0F, 11.0F, 5.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition leg_back_left = partdefinition.addOrReplaceChild("leg_back_left", CubeListBuilder.create()
				.texOffs(0, 45).addBox(9.0F, -3.0F, -4.0F, 5.0F, 11.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-6.0F, 16.0F, 17.0F));

		PartDefinition leg_front_right = partdefinition.addOrReplaceChild("leg_front_right", CubeListBuilder.create()
				.texOffs(66, 42).addBox(-2.0F, -2.0F, -3.0F, 6.0F, 14.0F, 6.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition leg_front_left = partdefinition.addOrReplaceChild("leg_front_left", CubeListBuilder.create()
				.texOffs(41, 42).addBox(-4.0F, -2.0F, -3.0F, 6.0F, 14.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(6.0F, 12.0F, -3.0F));
