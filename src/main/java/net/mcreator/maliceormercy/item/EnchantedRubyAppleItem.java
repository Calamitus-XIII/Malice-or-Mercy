...
import net.mcreator.maliceormercy.procedures.EnchantedRubyApplePlayerFinishesUsingItemProcedure;

public class EnchantedRubyAppleItem extends Item {
	public EnchantedRubyAppleItem() {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		EnchantedRubyApplePlayerFinishesUsingItemProcedure.execute(entity);
		return retval;
	}
}
