...
public class HumanEntity extends Monster {
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(4, new NearestAttackableTargetGoal(this, WitherSkeleton.class, false, false));
		this.targetSelector.addGoal(5, new NearestAttackableTargetGoal(this, CorruptFiendEntity.class, false, false));
		this.targetSelector.addGoal(6, new NearestAttackableTargetGoal(this, CorruptHoundEntity.class, false, false));
