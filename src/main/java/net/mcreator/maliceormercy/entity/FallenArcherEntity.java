...
public class FallenArcherEntity extends PathfinderMob implements RangedAttackMob {
	public FallenArcherEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MaliceOrMercyModEntities.FALLEN_ARCHER.get(), world);
	}

	public FallenArcherEntity(EntityType<FallenArcherEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 5;
		setNoAi(false);
	...
	public static void init() {
		SpawnPlacements.register(MaliceOrMercyModEntities.FALLEN_ARCHER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
