...
import net.mcreator.maliceormercy.block.SilverOreBlock;
import net.mcreator.maliceormercy.block.SapphireOreBlock;
import net.mcreator.maliceormercy.block.RubyOreBlock;
import net.mcreator.maliceormercy.block.PolishedCorruptStoneBlock;
import net.mcreator.maliceormercy.block.LiquidCorruptionBlock;
import net.mcreator.maliceormercy.block.DeepslateSilverOreBlock;
...
import net.mcreator.maliceormercy.block.CorruptslateBlock;
...
import net.mcreator.maliceormercy.block.CorruptSilverOreBlock;
import net.mcreator.maliceormercy.block.CorruptScaleBlock;
import net.mcreator.maliceormercy.block.CorruptSapphireOreBlock;
import net.mcreator.maliceormercy.block.CorruptSandstoneBlock;
import net.mcreator.maliceormercy.block.CorruptSandBlock;
import net.mcreator.maliceormercy.block.CorruptRubyOreBlock;
...
import net.mcreator.maliceormercy.block.CorriteOreBlock;
...
import net.mcreator.maliceormercy.block.BlockOfSilverBlock;
import net.mcreator.maliceormercy.block.BlockOfSapphireBlock;
import net.mcreator.maliceormercy.block.BlockOfRubyBlock;
import net.mcreator.maliceormercy.block.BlockOfRawSilverBlock;
import net.mcreator.maliceormercy.block.BlockOfCorriteBlock;
...
public class MaliceOrMercyModBlocks {
	...
	public static final RegistryObject<Block> POLISHED_CORRUPT_STONE = REGISTRY.register("polished_corrupt_stone", () -> new PolishedCorruptStoneBlock());
	...
	public static final RegistryObject<Block> CORRUPTSLATE = REGISTRY.register("corruptslate", () -> new CorruptslateBlock());
	...
	public static final RegistryObject<Block> CORRITE_ORE = REGISTRY.register("corrite_ore", () -> new CorriteOreBlock());
	...
	public static final RegistryObject<Block> CORRUPT_RUBY_ORE = REGISTRY.register("corrupt_ruby_ore", () -> new CorruptRubyOreBlock());
	...
	public static final RegistryObject<Block> CORRUPT_SAPPHIRE_ORE = REGISTRY.register("corrupt_sapphire_ore", () -> new CorruptSapphireOreBlock());
	...
	public static final RegistryObject<Block> CORRUPT_SILVER_ORE = REGISTRY.register("corrupt_silver_ore", () -> new CorruptSilverOreBlock());
	public static final RegistryObject<Block> BLOCK_OF_RAW_SILVER = REGISTRY.register("block_of_raw_silver", () -> new BlockOfRawSilverBlock());
	...
	public static final RegistryObject<Block> BLOCK_OF_CORRITE = REGISTRY.register("block_of_corrite", () -> new BlockOfCorriteBlock());
	public static final RegistryObject<Block> BLOCK_OF_SILVER = REGISTRY.register("block_of_silver", () -> new BlockOfSilverBlock());
