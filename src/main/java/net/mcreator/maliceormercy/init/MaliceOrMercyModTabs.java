...
public class MaliceOrMercyModTabs {
	...
	public static final RegistryObject<CreativeModeTab> MALICE_OR_MERCY = REGISTRY.register("malice_or_mercy",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.malice_or_mercy.malice_or_mercy")).icon(() -> new ItemStack(MaliceOrMercyModBlocks.CORRUPT_STONE.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(MaliceOrMercyModBlocks.POLISHED_CORRUPT_STONE.get().asItem());
				tabData.accept(MaliceOrMercyModBlocks.CORRUPT_STONE_BRICKS.get().asItem());
				tabData.accept(MaliceOrMercyModBlocks.CORRUPTSLATE.get().asItem());
				...
				tabData.accept(MaliceOrMercyModBlocks.CORRITE_ORE.get().asItem());
				...
				tabData.accept(MaliceOrMercyModBlocks.CORRUPT_RUBY_ORE.get().asItem());
				...
				tabData.accept(MaliceOrMercyModBlocks.CORRUPT_SAPPHIRE_ORE.get().asItem());
				tabData.accept(MaliceOrMercyModBlocks.SILVER_ORE.get().asItem());
				tabData.accept(MaliceOrMercyModBlocks.DEEPSLATE_SILVER_ORE.get().asItem());
				tabData.accept(MaliceOrMercyModBlocks.CORRUPT_SILVER_ORE.get().asItem());
				tabData.accept(MaliceOrMercyModBlocks.BLOCK_OF_RAW_SILVER.get().asItem());
				...
				tabData.accept(MaliceOrMercyModBlocks.BLOCK_OF_CORRITE.get().asItem());
				tabData.accept(MaliceOrMercyModBlocks.BLOCK_OF_SILVER.get().asItem());
				...
				tabData.accept(MaliceOrMercyModItems.CORRITE.get());
				tabData.accept(MaliceOrMercyModItems.RAW_SILVER.get());
				tabData.accept(MaliceOrMercyModItems.RUBY.get());
				tabData.accept(MaliceOrMercyModItems.SAPPHIRE.get());
				tabData.accept(MaliceOrMercyModItems.SILVER_INGOT.get());
				...
				tabData.accept(MaliceOrMercyModItems.COPPER_ARMOR_HELMET.get());
				tabData.accept(MaliceOrMercyModItems.COPPER_ARMOR_CHESTPLATE.get());
				tabData.accept(MaliceOrMercyModItems.COPPER_ARMOR_LEGGINGS.get());
				tabData.accept(MaliceOrMercyModItems.COPPER_ARMOR_BOOTS.get());
				tabData.accept(MaliceOrMercyModItems.COPPER_SWORD.get());
				tabData.accept(MaliceOrMercyModItems.COPPER_AXE.get());
				tabData.accept(MaliceOrMercyModItems.COPPER_PICKAXE.get());
				tabData.accept(MaliceOrMercyModItems.COPPER_SHOVEL.get());
				tabData.accept(MaliceOrMercyModItems.COPPER_HOE.get());
				tabData.accept(MaliceOrMercyModItems.SILVER_ARMOR_HELMET.get());
				tabData.accept(MaliceOrMercyModItems.SILVER_ARMOR_CHESTPLATE.get());
				tabData.accept(MaliceOrMercyModItems.SILVER_ARMOR_LEGGINGS.get());
				tabData.accept(MaliceOrMercyModItems.SILVER_ARMOR_BOOTS.get());
				tabData.accept(MaliceOrMercyModItems.SILVER_SWORD.get());
				tabData.accept(MaliceOrMercyModItems.SILVER_AXE.get());
				tabData.accept(MaliceOrMercyModItems.SILVER_PICKAXE.get());
				tabData.accept(MaliceOrMercyModItems.SILVER_SHOVEL.get());
				tabData.accept(MaliceOrMercyModItems.SILVER_HOE.get());
