...
public class Modeltest_ranged_biped<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("malice_or_mercy", "modeltest_ranged_biped"), "main");
	...
	public Modeltest_ranged_biped(ModelPart root) {
